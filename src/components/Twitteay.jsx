...
export default function Twitteay() {
    ...
    const [name, setName] = useState('AmmaBot');
    const [username, setUsername] = useState('ammae');
    const [theme, setTheme] = useState('ty-light-theme');
    const [source, setSource] = useState('Made with TwitEksyar');
    const [tweet, setTweet] = useState('hii!!! thank you for visiting "TwitEksyar" :3');
    ...
    (name == "") && setName('AmmaBot');
    (username == "") && setUsername('ammae');
    (tweet == "") && setTweet('hii!!! thank you for visiting "TwitEksyar" :3');
    ...
    const resetAll = () => {
        ...
        setSource('Made with TwitEksyar');
        setTweet('hii!!! thank you for visiting "TwitEksyar" :3');
        setLiked(false);
        setTime('00:00');
        setDate('2004-12-25');
        setRetweets('1,000');
    ...
    return (
        <>
            ...
            <Container fluid className="ty-edit">
                <h4 className="ty-edit-title">Edit Your TwitEksyar</h4>
                ...
                <div className="ty-edit-content">
                    <div className="ty-left-edit">
                        ...
                        <Form.Group className="mb-2">
                            ...
                            <Form.Control className="shadow-none" type="text" size="sm" id="name" placeholder="*Ammae" maxLength="28" autoComplete="off" onChange={(e) => setName(e.target.value)} />
                        </Form.Group>
                        <Form.Group className="mb-2">
                            <Form.Label className="ty-label-input mb-1" htmlFor="username">Username (Max 16 Char)</Form.Label>
                            <Form.Control className="shadow-none" type="text" size="sm" id="username" placeholder="*@ammae" maxLength="16" autoComplete="off" onChange={(e) => setUsername(e.target.value)} />
                        </Form.Group>
                    </div>
                    <div className="ty-middle-edit">
                        ...
                        <Form.Select className="mb-2 shadow-none" size="sm" onChange={(e) => setSource(e.currentTarget.value)}>
                            <option>Made with TwitEksyar</option>
                            <option value="TwitEksyar for iPhone">TwitEksyar for iPhone</option>
                            <option value="TwitEksyar for Android">TwitEksyar for Android</option>
                            <option value="TwitEksyar for Windows Phone">TwitEksyar for Windows Phone</option>
                            <option value="TwitEksyar for Web">TwitEksyar for Web</option>
                        </Form.Select>
                        <Form.Group className="mb-2">
                            <Form.Label className="ty-label-input mb-1" htmlFor="tweet">Tweet (Max 500 Char)</Form.Label>
                            <Form.Control className="shadow-none" as="textarea" size="sm" id="tweet" placeholder="*hii!!! thank you for visiting 'TwitEksyar'" maxLength="500" autoComplete="off" onChange={(e) => setTweet(e.target.value)} />
                        </Form.Group>
                    </div>
                ...
                <p className="ty-developer">Created with 💖 by Amma Bot</p>
            </Container>
        </>
    )
}